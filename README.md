...
This web app: **Veni-Vici is a React app that utilizes the RAWG Video Games Database API, which provides access to a comprehensive collection of video game data. This app can help users discover video games, and see their essential attributes such as the name, release date, and genre. Users can ban specific attributes by clicking on them, placing them on a ban list. Users can use this ability to filter for certain games, or explore new content.**
